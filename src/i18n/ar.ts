export default {
  ...
  notExhaustiveHint: 'أبرز النتائج وليست شاملة — جرّب صياغة أخرى لإيجاد آيات إضافية',
  ...
  sunnahFast: 'صيام تطوع',
  eventDot: 'مناسبة',
  fastingDay: 'يوم يُستحب صيامه',
  selectMonthYear: 'الانتقال إلى شهر',
  noCalendarData: 'لا توجد بيانات لهذا الشهر',
